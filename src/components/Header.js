...
import backgroundImage from '../img/pexels-thelazyartist-1780357.jpg';

const Header = () => {
  return (
    <header className="bg-cover bg-center h-screen" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <div className="flex items-center justify-center h-full bg-black bg-opacity-50">
        <div className="text-center text-white">
          <h1 className="text-5xl font-bold mb-4">Discover Your Future</h1>
          <p className="text-xl mb-6">For your Company Better</p>
          <div>
